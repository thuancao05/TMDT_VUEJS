...
export default defineComponent({
  setup() {
    ...
    const orders = reactive({
      ...
      name: "",
      note: "",
      date_of_order: ref(dayjs(), dateFormat),
      totalSum: "",
      totalItem: "",
      phone: "",
      status_id: "",
    ...
    const getOrderEdit = () => {
      ...
      axios
        ...
        .then((response) => {
          ...
          orders.date_of_order = ref(
            dayjs(response.data[0].dh_ngayDat, dateFormat)
          );
          orders.status_id = response.data[0].tt_id;
        })
        .catch((error) => {
          console.log(error);
        });
